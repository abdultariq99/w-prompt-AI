  ...
  return (
    <section className='w-full max-w-full flex-start flex-col'>
      ...
      className='mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism'>
        <label>
          <span className="font-satoshi font-semibold text-basse text-gray-700">
            Your AI Prompt
            </span>
            <textarea
            value={post.prompt}
            ...
            required
            className="form_textarea border border-gray-700"
            />    
        </label>
        ...
        <label>
          <span className="font-satoshi font-semibold text-basse text-gray-700">
            ...
            placeholder="#tag"
            required
            className="form_input mb-20 border border-gray-700"
            />    
        </label>
